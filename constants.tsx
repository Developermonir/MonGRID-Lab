...
export const JUSTIFY_CONTENT_OPTIONS = ['flex-start', 'flex-end', 'center', 'space-between', 'space-around', 'space-evenly'];
export const ALIGN_ITEMS_OPTIONS = ['flex-start', 'flex-end', 'center', 'baseline', 'stretch'];
export const ALIGN_CONTENT_OPTIONS = ['flex-start', 'flex-end', 'center', 'space-between', 'space-around', 'stretch'];
export const ALIGN_SELF_OPTIONS = ['auto', ...ALIGN_ITEMS_OPTIONS];
